...
if( !class_exists( 'NTH_Portfolio_Front' ) ) {
	
	class NTH_Portfolio_Front extends NTH_Portfolio {
		...
		private function init_shortcode(){
			add_shortcode( 'nth_portfolio', array($this, 'nth_portfolio') );
		}
		...
		public function nth_portfolio( $atts = array() ){
			...
			<div class="nth-portfolios-wrapper">
				...
				<div class="nav nth-page-nav nth-portfolio-navigation">
					<?php 
					$links = paginate_links( array(
		...
		private function get_filters(){
			$cats = $this->getCats();
			?>
			<ul class="nth-portfolio-filters">
		...
		private function get_content( $atts = array() ){
			global $wp_query;
	...
	$nth_portfolio_front = new NTH_Portfolio_Front();
}
