...
if( !class_exists( 'NTH_TeamMembers_Admin' ) ) {
	
	class NTH_TeamMembers_Admin extends NTH_TeamMembers {
	...
	global $NTH_TeamMembers_Admin;
	$NTH_TeamMembers_Admin = new NTH_TeamMembers_Admin();
}
