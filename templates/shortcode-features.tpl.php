...
<?php endif;?>
	...
	<div class="features <?php echo esc_attr($short_id);?> columns-<?php echo absint($per_row);?><?php if(absint($use_boxed)) echo ' row';?>">
		...
		<?php $i = 0; foreach( $nth_features as $post ): $i++;?>
		...
		<div class="<?php echo esc_attr($class);?>">
			...
			<div class="<?php echo esc_attr($class_inner);?>">
				...
				<div class="feature-sumary">
					...
					<?php if( absint($learn_more) > 0 ):?>
					
					<p class="learn-more-wrap"><a class="learn-more-link text-uppercase" href="<?php echo esc_url($post->url);?>" title="<?php echo esc_attr(get_the_title());?>"><?php _e("Learn more", 'theshopier');?> <i class="fa fa-long-arrow-right"></i></a></p>
