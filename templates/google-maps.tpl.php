...
<div id="map-<?php echo esc_attr($map_id);?>" style="height: <?php echo esc_attr($height);?>" class="map-wrapper"></div>
<div id="save-widget-<?php echo esc_attr($map_id);?>" class="hidden maps-save-widget">
	...
	function geocodeAddress(geocoder, resultsMap, address) {
		...
		geocoder.geocode({'address': address}, function(results, status) {
			if (status === google.maps.GeocoderStatus.OK) {
				...
				widgetDiv.className  = "maps-save-widget";
			} else {
